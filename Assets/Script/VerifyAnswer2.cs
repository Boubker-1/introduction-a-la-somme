...
public class VerifyAnswer2 : MonoBehaviour
{
	...
	public void Verify()
	{
		...
		if (GameControl.n1 == GameControl.slot1 + GameControl.slot2) GameControl.correctAnswer = true;
	...
	public void Verify2()
	{
		...
		if (SumCandyControl.n1 == SumCandyControl.numberTray1 + SumCandyControl.numberTray2) SumCandyControl.correctAnswer = true;
	...
	public void Verify1E()
	{
		...
		{
			if (EquationControl.n1 == EquationControl.CorrectInts[0])
			{
	...
	public void Verify2E()
	{
		...
		{
			if (EquationControl.n4 == EquationControl.CorrectInts[1])
			{
	...
	public void Verify3E()
	{
		...
		{
			if (EquationControl.n7 == EquationControl.CorrectInts[2])
			{
