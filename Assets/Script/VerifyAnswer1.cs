...
public class VerifyAnswer1 : MonoBehaviour
{
	...
	public void Verify()
	{
		...
		if (GameControl.n0 == GameControl.slot1 + GameControl.slot2) GameControl.correctAnswer = true;
	...
	public void Verify2()
	{
		...
		if (SumCandyControl.n0 == SumCandyControl.numberTray1 + SumCandyControl.numberTray2) SumCandyControl.correctAnswer = true;
